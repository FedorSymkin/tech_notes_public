...
* Проезд по зелёной доп. секции - всем уступаем
* Если есть доп. секция в какую-то сторону, **ехать в эту сторону можно только когда она зелёная**
    * Т.е. когда просто горит основной зелёный и нет зелёной доп. секции, **ехать в сторону этой доп. секции нельзя**
* Иногда для удобства на основном зелёном нарисованы контурные стрелки, показывающие куда разрешает этот зелёный (чтобы случайно не нарушали пункт выше)
* Пример доп. секции и конрутных стрелок

![image0030](image0030.png)

* Важный момент - на зелёной стрелке нельзя стоять, создавать затор для стоящих сзади:
    * Допустим мы оказались на крайней полосе со стрелкой и ходим вперёд
    * Вперёд горит красный, а стрелка зелёная
    * А сзади нас машины, которые хотят повернуть
    * В этом случае **мы обязаны тоже повернуть**, чтобы не создавать им затор

### Про стрелки в основных огнях светофора
* Иногда бывают стрелки (не контурные, а такие же как доп. секции) прямо в основных сигналах светофора

![image0031](image0031.png)

* Это значит, что данный сигнал распространяется только на направление стрелки
* Если про другие направления ничего не сказано - как на рисунке - значит, **ехать в других направлениях нельзя**

### Перманентная доп. секция

![image0032](image0032.png)

* По смыслу это как бы доп. секция, которая зелёная всегда
* Здесь не действует обязанность повернуть, чтобы не создавать затор (ну потому что зелёная стрелка по сути вечная)
...
* По мере уменьшения приоритета (если пункта нет, переходим к следующему):
    * Стоп-линия или знак "СТОП" (не путать со "STOP")
    * Разметка, типа "уступи дорогу"
